...
export const INITIAL_TASKS: Task[] = [
  {
    ...
    subtasks: [
      ...
      { id: nanoid(), title: 'Create Layout wrapper', completed: false },
      { id: nanoid(), title: 'Add responsive styles', completed: false },
    ],
    estimatedHours: 4,
  ...
  },
  {
    ...
    subtasks: [
      ...
      { id: nanoid(), title: 'Add neon glow effects', completed: false },
    ],
    estimatedHours: 6,
  ...
  },
  {
    ...
    subtasks: [
      ...
      { id: nanoid(), title: 'Create content calendar', completed: false },
      { id: nanoid(), title: 'Write 5 post templates', completed: false },
    ],
    estimatedHours: 3,
  ...
  },
  {
    ...
    subtasks: [
      ...
      { id: nanoid(), title: 'Test auto-commit on push', completed: false },
    ],
    estimatedHours: 5,
  ...
  },
  {
    ...
    subtasks: [
      ...
      { id: nanoid(), title: 'Test responsive layouts', completed: false },
      { id: nanoid(), title: 'Test keyboard shortcuts', completed: false },
    ],
    estimatedHours: 6,
    createdAt: new Date(Date.now() - 60480000).toISOString(),
    updatedAt: new Date(Date.now() - 60480000).toISOString(),
  },
  {
    id: nanoid(),
    ...
    subtasks: [
      ...
      { id: nanoid(), title: 'Finalize contract terms', completed: false },
    ],
    estimatedHours: 10,
  ...
  },
  {
    ...
    subtasks: [
      ...
      { id: nanoid(), title: 'Write executive summary', completed: false },
      { id: nanoid(), title: 'Create visual charts', completed: false },
    ],
    estimatedHours: 12,
  ...
  },
  {
    ...
    subtasks: [
      ...
      { id: nanoid(), title: 'Build basic voice recognition', completed: false },
      { id: nanoid(), title: 'Integrate with command system', completed: false },
    ],
    estimatedHours: 15,
